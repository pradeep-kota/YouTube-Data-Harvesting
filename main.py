...
with col1:
    ...
    if Get_data or st.session_state.Get_state:
        ...
        ''' to get YouTube api key follow the document listed in this repo'''
...
if Check_channel:
    ...
    engine = create_engine('mysql+mysqlconnector://root:mysqlconnection123@127.0.0.1/youtube_db', echo=False)
...
connect_for_question = pymysql.connect(host='127.0.0.1', user='root', password='mysqlconnection123', db='youtube_db')
